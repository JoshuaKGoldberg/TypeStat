...
const declaredTypeIsEquivalent = (typeChecker: ts.TypeChecker, declaredType: ts.Type, initializedType: ts.Type) => {
    ...
    if (
        isAssignableToType(declaredType, initializedType, typeChecker) &&
        isAssignableToType(initializedType, declaredType, typeChecker) &&
...
/**
 * Checks intrinsic names of types that wouldn't have been caught with `isAssignableToType`.
 */
