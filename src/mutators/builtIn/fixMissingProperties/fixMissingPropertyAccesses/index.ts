...
export const fixMissingPropertyAccesses: FileMutator = (request: FileMutationsRequest): readonly IMutation[] => {
    ...
    const suggestedMissingProperties = new Set<string>(),
        visitPropertyAccessExpression = (node: ts.PropertyAccessExpression): IMutation | undefined => {
