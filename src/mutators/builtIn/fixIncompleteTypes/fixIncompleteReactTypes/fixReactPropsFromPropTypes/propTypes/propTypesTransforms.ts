...
const createArrayOfTransform = (accessNode: PropTypesAccessNode) => {
    ...
    createInstanceOfTransform = (accessNode: PropTypesAccessNode) => {
        if (!ts.isCallExpression(accessNode.parent) || accessNode.parent.arguments.length !== 1) {
            return undefined;
        }
    ...
    createOneOfTransform = (accessNode: PropTypesAccessNode) => {
        if (!ts.isCallExpression(accessNode.parent) || accessNode.parent.arguments.length !== 1) {
            return undefined;
        }
    ...
    createOneOfTypeTransform = (accessNode: PropTypesAccessNode) => {
        if (!ts.isCallExpression(accessNode.parent) || accessNode.parent.arguments.length !== 1) {
            return undefined;
        }
    ...
    createShapeTransform = (accessNode: PropTypesAccessNode) => {
        if (!ts.isCallExpression(accessNode.parent) || accessNode.parent.arguments.length !== 1) {
            return undefined;
        }
