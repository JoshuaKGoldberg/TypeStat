...
const collectMissingAssignedTypesOnChildClassNode = (
    ...
    if (!isAssignableToType(expressionType, childClassType, typeChecker)) {
        return undefined;
    }
...
const getMissingAssignedType = (
    ...
    if (defaultTypeParameterType !== undefined && isAssignableToType(rightExpressionType, defaultTypeParameterType, typeChecker)) {
        return undefined;
    }
