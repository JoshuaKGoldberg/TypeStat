...
export const fixIncompleteParameterTypes: FileMutator = (request: FileMutationsRequest): readonly IMutation[] =>
...
const visitParameterDeclaration = (node: ts.ParameterDeclaration, request: FileMutationsRequest): IMutation | undefined => {
    ...
    getCallingTypesFromReferencedSymbols = (node: ts.ParameterDeclaration, request: FileMutationsRequest): readonly ts.Type[] => {
