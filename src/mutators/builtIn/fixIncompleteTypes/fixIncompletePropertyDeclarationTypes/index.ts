...
export const fixIncompletePropertyDeclarationTypes: FileMutator = (request: FileMutationsRequest): readonly IMutation[] =>
...
const visitPropertyDeclaration = (node: ts.PropertyDeclaration, request: FileMutationsRequest): IMutation | undefined => {
    ...
    collectPropertyAssignedTypes = (node: ts.PropertyDeclaration, request: FileMutationsRequest): readonly ts.Type[] => {
     ...
     */
    updateAssignedTypesForReference = (identifier: ts.Node, assignedTypes: ts.Type[], request: FileMutationsRequest): void => {
